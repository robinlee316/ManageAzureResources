...
namespace CreateVM_V1._0
{
    class Program
    {
        ...
        private const string clientAppId = "7c77efe9-9330-40cc-9af1-a1e7e0663a81";
        private const string clientAppsecret = "m132XQyrD+82Jui9DHHNL/oRVYBBchCqWulfp5tcVkE=";


        private const string groupName = "RLResourceGroup0002";
        private const string subscriptionId = "28048307-7d00-4573-8937-4d641650850c";
        ...
        private const string adminName = "v-role";
        private const string adminPassword = "Chenling005";
        ...
        private static async Task<AuthenticationResult> GetAccessTokenAsync()
        {
            ...
            var context = new AuthenticationContext("https://login.windows.net/72f988bf-86f1-41af-91ab-2d7cd011db47");
